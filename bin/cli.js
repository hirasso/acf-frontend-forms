...
const commands = {
  ...
  "test:dev": {
    fn: testDev,
    description: "Run tests against the development (unscoped) version of the plugin",
  },
  "test:release": {
    fn: testRelease,
...
if (!isAtRootDir()) {
  error(`${basename(__filename)} must be executed from the package root directory`);
}
