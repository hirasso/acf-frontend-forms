...
(() => {
  ...
  (($3, acf2) => {
    ...
    function adjustRepeater($repeater, action) {
      ...
      const plusIcon = import_feather_icons.default.icons["plus-circle"].toSvg();
      const minusIcon = import_feather_icons.default.icons["minus-circle"].toSvg();
